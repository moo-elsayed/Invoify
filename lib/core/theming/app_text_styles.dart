...
class AppTextStyles {
  ...
  static TextStyle get font16Bold =>
      GoogleFonts.cairo(fontSize: 16.sp, fontWeight: .w700);

  static TextStyle get font18Bold =>
      GoogleFonts.cairo(fontSize: 18.sp, fontWeight: .w700);

  static TextStyle get font20Bold =>
      GoogleFonts.cairo(fontSize: 20.sp, fontWeight: .w700);

  static TextStyle get font22Bold =>
      GoogleFonts.cairo(fontSize: 22.sp, fontWeight: .w700);

  static TextStyle get font24Bold =>
      GoogleFonts.cairo(fontSize: 24.sp, fontWeight: .w700);

  static TextStyle get font32Bold =>
      GoogleFonts.cairo(fontSize: 32.sp, fontWeight: .w700);
}
